...
prisma.$connect()
  .then(() => console.log("CREATE-PAYMENT-INTENT: Prisma connected to MongoDB successfully"))
  .catch((error) => console.error("CREATE-PAYMENT-INTENT: Prisma connection failed:", error));

const stripe = new Stripe(process.env.STRIPE_SECRET_KEY!, {
  apiVersion: "2025-04-30.basil",
});

console.log("CREATE-PAYMENT-INTENT: Stripe initialized with key prefix:", process.env.STRIPE_SECRET_KEY?.substring(0, 10) + "...");
